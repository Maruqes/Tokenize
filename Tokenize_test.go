...
func TestThis(t *testing.T) {
	Init("4242", "/success.html", "/cancel.html", TypeOfSubscriptionValues.OnlyStartOnDayXNoSubscription, []ExtraPayments{ExtraPaymentsValues.MBWay, ExtraPaymentsValues.Multibanco})
}
